...
def calculate_metrics_postgresql(curr, i):
	...
	curr.execute(
		"insert into dummy_metrics(timestamp, prediction_drift, num_drifted_columns, share_missing_values, fare_quantile, col_corr) values (%s, %s, %s, %s, %s, %s)",
		(begin + datetime.timedelta(i), prediction_drift, num_drifted_columns, share_missing_values, quantile_metric, corr_metric)
	)
